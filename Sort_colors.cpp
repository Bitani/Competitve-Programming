...
- Similarly, if 1 is seen then it'll keep it as it is but shrink the unknown range(array[Middle to top-1]) and if 2 is encountered swap it with element at Top Position.

    ** keep incrementing and decrementing the variables "Top", "Bottom" & "Middle" 
    
    */

// You can get a better understanding from the resource "https://www.geeksforgeeks.org/sort-an-array-of-0s-1s-and-2s/"
